...
<body>
	<div class="hero-wrap"
		...
		<div class="container">
			<div class="">
				...
				<div>
					<h1
						style="color: white; position: relative; top: 250px; left: 200px;">
						ĐẶT VÉ CHƯA BAO GIỜ DỄ DÀNG ĐẾN VẬY</h1>
				</div>
				<!-- end test -->
					...
					<form:form action="xu-ly-tim-kiem" method="GET"
						...
						<div class="row">
							...
							<div class="col-lg align-self-end">
								<div class="form-group">
									<div class="form-field">
										<Button class="w3-button w3-orange w3-round-large"
											type="submit"
											style="width: 100%; font-family: Tahoma, Đặt vé ngayman, Verdana;">
											TÌM VÉ XE</Button>
									</div>
								</div>
							</div>
				...
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services">
						<div class="media-body py-md-4">
							<div class="d-flex mb-3 align-items-center">
								<div class="icon">
									<span class="flaticon-online-Đặt vé ngaying"></span>
								</div>
	...
	<section class="ftco-section">
		<div class="container-fluid px-4">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="xe-wrap ftco-animate">
						<div class="img d-flex align-items-end"
							style="background-image: url('template/web/images/xe-1.jpg'); height: 150px">
						</div>
						<div class="text p-4 text-center">
							<h2 class="mb-0">
								<a href="#">Tuyến Đặc biệt</a>
							</h2>
							<span>12-01-2020</span>
							<p class="d-flex mb-0 d-block">
								<a href="#" class="btn btn-black btn-outline-black mr-1">Đặt
									vé ngay </a> <a href="#"
									class="btn btn-black btn-outline-black ml-1">Chi tiết</a>
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="xe-wrap ftco-animate">
						<div class="img d-flex align-items-end"
							style="background-image: url('template/web/images/Xe-2.jpg'); height: 150px">
						</div>
						<div class="text p-4 text-center">
							<h2 class="mb-0">
								<a href="#">Tuyến Đặc biệt</a>
				...
				<div class="col-md-3">
					<div class="xe-wrap ftco-animate">
						<div class="img d-flex align-items-end"
							style="background-image: url('template/web/images/xe-3.jpg');height: 150px">
						</div>
						<div class="text p-4 text-center">
							<h2 class="mb-0">
								<a href="#">Tuyến Đặc biệt</a>
							...
							<span>12-01-2020</span>
							<p class="d-flex mb-0 d-block">
								<a href="#" class="btn btn-black btn-outline-black mr-1">Đặt vé ngay
									</a> <a href="#" class="btn btn-black btn-outline-black ml-1">Chi tiết</a>
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="xe-wrap ftco-animate">
						<div class="img d-flex align-items-end"
							style="background-image: url('template/web/images/xe-4.jpg');height: 150px">
						</div>
						<div class="text p-4 text-center">
							<h2 class="mb-0">
								<a href="#">Tuyến Đặc biệt</a>
