...
<link rel="stylesheet"
	href="<c:url value='/template/web/css/ionicons.min.css'/>"
	type="text/css">
...
<link rel="stylesheet"
	...
	type="text/css">
<link rel="stylesheet"
	href="<c:url value='/template/web/css/jquery.timepicker.css'/>"
	type="text/css">


<link rel="stylesheet"
	href="<c:url value='/template/web/css/flaticon.css'/>" rel="stylesheet"
	type="text/css">
<link rel="stylesheet"
	href="<c:url value='/template/web/css/icomoon.css'/>" rel="stylesheet"
	type="text/css">
<link rel="stylesheet"
...
<body>
	<!-- Navigation -->
	<%@ include file="/Chung/web/header.jsp"%>

	<dec:body />

	<!-- Footer -->
	<%@ include file="/Chung/web/footer.jsp"%>

	<script src="<c:url value='/template/web/js/jquery.min.js'/>">
		
	</script>
	<script
		src="<c:url value='/template/web/js/jquery-migrate-3.0.1.min.js'/>"></script>
	...
	<script
		src="<c:url value='/template/web/js/jquery.animateNumber.min.js'/>"></script>
	<script src="<c:url value='/template/web/js/bootstrap-datepicker.js'/>"></script>
	<script
		src="<c:url value='/template/web/js/jquery.timepicker.min.js'/>"></script>
